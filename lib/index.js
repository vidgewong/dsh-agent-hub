...
if (!callIdBrand) {
  throw new Error(
    "@deepseek-ai/dsh-llm exports neither ToolCallId nor CallId; this dsh-llm version is not supported by dsh-agent-hub"
  );
}
...
async function deriveProviderEnv(ctx, provider) {
