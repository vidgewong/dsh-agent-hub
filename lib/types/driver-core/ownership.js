 ...
 * them verbatim.
 *
 * @module dsh-omniloop/driver-core/ownership
 */
...
export async function raceAbort(operation, signal, id) {
    const toAbortError = () => {
...
export async function raceAbortCall(operation, signal, id, releaseAbandoned) {
    if (signal.aborted) {
