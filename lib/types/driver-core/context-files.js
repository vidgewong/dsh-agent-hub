 ...
 */
export async function projectAncestors(cwd) {
 ...
 */
export async function collectProjectContextFiles(cwd, policy) {
    const files = [];
 ...
 */
export async function anySourceNonEmpty(paths) {
 ...
 */
export async function fileNonEmpty(path) {
    const raw = await readOptionalFile(path);
